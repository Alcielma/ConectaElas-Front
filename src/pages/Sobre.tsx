        ...
        <div className="sobre-text-container">
          ...
          <div className="sobre-text">
            <p>
              ...
              fortalecer os direitos das mulheres e combater a violência
              doméstica e familiar na cidade de{" "}
              <strong>Lagoa de Itaenga (PE)</strong>.
            </p>
            <p>
            ...
            <p>
              Aqui, você encontra conteúdos informativos sobre seus direitos,
            ...
            <p>
              ...
              fortalecimento da autonomia das mulheres e a construção de um
              espaço seguro e de confiança.
            </p>
            <p>
